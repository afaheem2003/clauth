...
export async function POST(req) {
  ...
  // Fully qualified image for Stripe
  const fullImage =
    imageUrl.startsWith("http") ? imageUrl : `${origin}${imageUrl}`;

  try {
    // create a Checkout Session; metadata + client_reference_id let us know what to log
    ...
    // only return the session ID — we log the Preorder in the webhook below
